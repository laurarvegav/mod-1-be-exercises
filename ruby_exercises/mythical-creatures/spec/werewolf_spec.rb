...
RSpec.describe Werewolf do
  ...
  it 'cannot consume a victim if it is in human form' do
    ...
    expect(werewolf.eat(victim)).to eq("Werewolf David cannot consume a victim if it is in human form")

    werewolf.change!

    expect(werewolf.eat(victim)).to eq("Werewolf David ate the victim")
  end
